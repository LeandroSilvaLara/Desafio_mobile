...
class SearchAdapter(private val onMovieClickListener: OnMovieClickListener) :
    ...
    inner class SearchViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        private val imageViewMovieSearch: ImageView =
            itemView.findViewById(R.id.image_view_movie_search_item)
        private val textViewMovieTitleSearch: TextView =
            itemView.findViewById(R.id.text_view_movie_title_search)
        private val textViewMovieGenderSearch: TextView =
            itemView.findViewById(R.id.text_view_movie_gender_search)
        private val textViewMoviePremierDateSearch: TextView =
            itemView.findViewById(R.id.text_view_movie_premier_date_search)
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): SearchViewHolder {
        return SearchViewHolder(
            LayoutInflater.from(parent.context)
                .inflate(R.layout.row_movie_search_item, parent, false)
        )
    }
